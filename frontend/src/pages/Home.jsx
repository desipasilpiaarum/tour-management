                    ...
                    <Row>
                        ...
                        <Col lg="6">
                            <div className="hero__content">
                                ...
                                <p>
                                    Jelajahi keindahan Tasikmalaya, dari hijauhnya Perkebunan Teh Taraju hingga
                                    megahnya Curug Dengdeng. Rasakan keunikan budaya di Kampung Naga dan nikmati lezatnya
                                    nasi tutug oncom. Setiap sudut kota ini menyimpan cerita, setiap perjalanan menciptakan
                                    kenangan.  </p>
                            </div>
                        </Col>
                        <SearchBar />
                    ...
                    <Row>
                        <Col lg="6">
                            <div className="experience__content">
                                ...
                                <h2>Semua Wisata Kami Yang <br />Akan Melayani Anda</h2>

                                <p>Bersama wisata kami ajakan keluarga
                                    serta teman teman anda untuk menikmati
                                    keindahan wisata yang ada di tasikmalaya</p>
                            </div>
