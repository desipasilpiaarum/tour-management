      ...
      <section className="my-2">
        <Container className="text-center">
          ...
          <div className="image-gallery mt-4">
            <Slider {...settings}>
              <div>
                <img src={wisata1} alt="Sawer" className="carousel-image" />
              </div>
              <div>
                <img src={wisata2} alt="Naga" className="carousel-image" />
              </div>
              <div>
                <img src={wisata3} alt="Kacapi" className="carousel-image" />
              </div>
              <div>
                <img src={wisata4} alt="Pantai" className="carousel-image" />
              </div>
              <div>
                <img
                  src={wisata5}
